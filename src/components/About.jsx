...
function About() {
    return (
        <Box sx={{ maxWidth: 400, margin: 'auto', padding: 2, border: '1px solid #ddd', borderRadius: 2 }}>
            ...
            <Typography variant="body1"><strong>Nombre:</strong> Edwin Guerrero Cortez, Adair Hernández Escobar</Typography>
            <Typography variant="body1"><strong>Matrícula:</strong>  20221030, 20221018 </Typography>
